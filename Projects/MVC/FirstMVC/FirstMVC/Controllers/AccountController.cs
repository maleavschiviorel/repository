...
namespace NHibernate.AspNet.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult RegisterRole()
        {
            ...
            var roleStore = new RoleStore<IdentityRole>(NHibernateSession.Current);
            var userStore = new UserStore<IdentityUser>(NHibernateSession.Current);
           
            ViewBag.RoleName = new SelectList(roleStore.Roles, "Name", "Name");
            ViewBag.UserName = new SelectList(userStore.Users, "UserName", "UserName");
